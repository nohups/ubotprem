...
from fansx import bot, ubot
from fansx.core.helpers import PY
from fansx.modules import loadModule
...
async def loadPlugins():
    modules = loadModule()
    for mod in modules:
        imported_module = importlib.import_module(f"fansx.modules.{mod}")
