...
async def _(client, message):
    buttons = BTN.NOHUP(message)
    sh = await message.reply("""<u><b>𝗙𝗜𝗧𝗨𝗥 𝗙𝗥𝗘𝗘 𝗔𝗟𝗗𝗜 𝗨𝗦𝗘𝗥𝗕𝗢𝗧!</b></u>
...
<b>ᴏᴡɴᴇʀ ᴜsᴇʀʙᴏᴛ: <a href=https://t.me/ajigz>サンエイ</a></b></blockquote>""", reply_markup=InlineKeyboardMarkup(buttons))